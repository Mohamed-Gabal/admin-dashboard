                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 text-gray-400 hover:text-blue-600 transition-colors cursor-pointer"
                      >
                        <Eye size={16} />
                      </button>
                      <button
                        onClick={() => toast.error(`Deleted ${user.firstName}`)}
